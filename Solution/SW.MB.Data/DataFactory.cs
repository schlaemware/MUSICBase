  ...
  public sealed class DataFactory {
    ...
    public void ConfigureServices(IServiceCollection services, IConfiguration configuration) {
      ...
      if (string.IsNullOrEmpty(sqliteConnectionString)) {
        sqliteConnectionString = Path.Combine(configuration["AppDirectory"], "Storage", $"MBStorage_{configuration["AppVersion"]}.db");
        if (Path.GetDirectoryName(sqliteConnectionString) is string directory) {
